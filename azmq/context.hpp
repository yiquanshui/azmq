...
AZMQ_V1_INLINE_NAMESPACE_BEGIN
    ...
    boost::system::error_code set_option(boost::asio::io_context & io_service,
                                         const Option & option,
     ...
     */
    template<typename Option>
    void set_option(boost::asio::io_context & io_service, const Option & option) {
        boost::system::error_code ec;
     ...
     */
    template<typename Option>
    boost::system::error_code get_option(boost::asio::io_context & io_service,
                                         Option & option,
                                         boost::system::error_code & ec) {
     ...
     */
    template<typename Option>
    void get_option(boost::asio::io_context & io_service, Option & option) {
        boost::system::error_code ec;
